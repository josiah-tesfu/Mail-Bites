...
**Description:** Container for toolbar elements (new email, search, filters)
...
[text](https://encommun.montpellier.fr/sites/default/files/articles/2024-11/Guide%20du%20partage%20de%20la%20rue_4.pdf)
| **Category** | **Details** |
|--------------|-------------|
